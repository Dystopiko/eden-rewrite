...
use eden_sqlx_sqlite::{PoolError, PooledConnection, Transaction};
use error_stack::Report;
use std::{fmt, sync::Arc, time::Instant};

#[derive(Builder, Clone)]
pub struct DatabasePools {
    primary: eden_sqlx_sqlite::Pool,
    replica: Option<eden_sqlx_sqlite::Pool>,
...
impl DatabasePools {
    ...
    #[must_use]
    pub fn primary(&self) -> &eden_sqlx_sqlite::Pool {
        &self.primary
    }
    ...
    #[must_use]
    pub fn replica(&self) -> Option<&eden_sqlx_sqlite::Pool> {
        self.replica.as_ref()
    }
}
