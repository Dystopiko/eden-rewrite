...
use crate::{snowflake::Snowflake, tables::linked_mc_account::LinkedMcAccount};
...
impl NewMcLoginEvent {
    pub fn from_linked(account: &LinkedMcAccount) -> BuilderFromLinked {
...
mod private {
    ...
    pub type BuilderFromLinked =
        NewMcLoginEventBuilder<SetMemberId<SetEdition<SetUsername<SetPlayerUuid<Empty>>>>>;
}
...
mod tests {
    ...
    use crate::{
        tables::mc_login_event::NewMcLoginEvent, testing::krate::member_with_linked_mc_account,
    };
